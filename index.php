  ...
  <section class="banner bg-light">
      ...
      <div class="row">
          <div class="col-lg-6 banner-text">
            <h1 class="pt-5">Your Gateway To Alternative Investments.</h1>
            <h4 class="py-3">Take control with all-in-one investment, retirement, checking and more.</h4>
            <div class="header-button">
                <a onclick="openNav()" class="btn btn-common px-5 text-white">GET STARTED</a>
            </div>
          </div>
          <div class="col-lg-6 text-center">
            <img src="images/banner-img.png" data-aos="fade-left" data-aos-easing="ease-out-back" data-aos-duration="800" data-aos-delay="0" alt="" width="550" class="img-fluid">
          </div>
          </div>
      </div>
  </section>
  ...
  <section class="Why_clients my-5 ">
      <div class="container">
          <div class="section-header text-center pb-4">
              ...
              <h3 class="h3">We Make Investing and Fundraising Easy</h3>
          </div>
          <div class="row">
              <div class="col-md-5 col-lg-5">
                  <h3 class="head-title 32">For Investor</h3>
              </div>
          </div>
          <div class="client-data py-4">
              <div class="row">
                  <div class="col-md-4 col-lg-4">
                      <div class="services-item" data-aos="fade-up" data-aos-duration="3000">
                          <div class="icon1 text-center">
                              <i class="fa fa-line-chart" aria-hidden="true"></i>
                          </div>
                          <h4>Access highly quality ‘sponsored’ Startups</h4>
                          <p>Our team works to orignate, curate and present disruptive and hyper growth ventures.</p>
                      </div>
                  </div>
                  <div class="col-md-4 col-lg-4">
                      <div class="services-item" data-aos="fade-up" data-aos-duration="3000">
                          ...
                          <p>Diversify wealth via an asset class fundamentally different from conventional real estate
                  ...
                  <div class="col-md-4 col-lg-4">
                      <div class="services-item" data-aos="fade-up" data-aos-duration="3000">
                          ...
                          <p>Our platform allows you access to elevator pitches directly from our founders</p>
                      </div>
                  </div>
              </div>
          </div>
          <div class="row">
              <div class="col-md-5">
                  <h3 class="head-title h3">For Founder</h3>
              </div>
          </div>
          <div class="client-data py-4">
              <div class="row">
                  ...
                  <div class="col-md-4 col-lg-4">
                      <div class="services-item" data-aos="fade-up" data-aos-duration="3000">
                          ...
                          <p>Our realtime chat platform helps you connect with investors quickly and engage in
 ...
 <section class="aboutus bg-light py-5">
          ...
          <div class="row">
              ...
              <div class="col-md-12 col-lg-6">
                  <div class="contents" data-aos="fade-up" data-aos-duration="3000">
                      ...
                      <div class="header-button">
                          <a onclick="openNav()" class="btn btn-common text-white">GET STARTED</a>
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-lg-6">
  ...
  <!-- aboutus section ends -->
   ...
   <!-- share-trade start -->
   <section class="share-trade py-5">
      <div class="container">
      <div class="row">
          <div class="col-md-12 col-lg-7">
            <img src="images/mobile1.png" data-aos="fade-right" data-aos-easing="ease-out-back" data-aos-duration="800" data-aos-delay="0" width="280" class="top-image img-fluid" alt="Responsive image">
            <img src="images/mobile2.png"  data-aos="fade-right" data-aos-easing="ease-out-back" data-aos-duration="800" data-aos-delay="600" class="img-fluid bottom-img" alt="Responsive image">
          </div>
          <div class="col-md-12 col-lg-5 text-center earn">
            <h2 class="pb-3">Earn Found Money</h2>
...
<!-- share-trade end -->
  ...
  <section class="testimonials pt-5 bg-light" id="testimonial">
      <div class="container">
          <div class="section-header text-center pb-4">
              <h2 class="head-title">What our clients say</h2>
          </div>
          <div class="row">
              <div class="col-md-12">
                  <div id="testimonial-slider" class="owl-carousel">
                      <div class="testimonial">
                          <div class="testimonial-review shadow">
                              <p>
                          ...
                          <div class="pic">
                              <img src="images/testiprofile1.jpg" alt="">
                      ...
                      <div class="testimonial">
                          ...
                          <div class="pic">
                              <img src="images/testiprofile2.jpg" alt="">
                      ...
                      <div class="testimonial">
                          ...
                          <div class="pic">
                              <img src="images/testiprofile3.jpg" alt="">
  ...
  <section class="get-benefits py-5">
      <div class="container">
          <div class="row py-2">
              <div class="col-md-8 col-lg-10">
                  <h2 class="head-title">Take your first steps towards your financial success</h2>
              </div>
              <div class="col-md-4 col-lg-2">
              <div class="banner pt-4">
                  <form action="sign-up.php">
                        <button type="submit"  class="bannerbtn2">Sign Up Now</button>
                  </form>
              </div>
              </div>
          </div>
